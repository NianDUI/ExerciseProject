...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<top.niandui.grpc.HelloRequest,
      top.niandui.grpc.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = top.niandui.grpc.HelloRequest.class,
      responseType = top.niandui.grpc.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<top.niandui.grpc.HelloRequest,
      top.niandui.grpc.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<top.niandui.grpc.HelloRequest, top.niandui.grpc.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
          HelloServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<top.niandui.grpc.HelloRequest, top.niandui.grpc.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  top.niandui.grpc.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  top.niandui.grpc.HelloReply.getDefaultInstance()))
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void sayHello(top.niandui.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<top.niandui.grpc.HelloReply> responseObserver) {
    ...
    @Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                top.niandui.grpc.HelloRequest,
                top.niandui.grpc.HelloReply>(
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloServiceBlockingStub> {
     ...
     * </pre>
     */
    public top.niandui.grpc.HelloReply sayHello(top.niandui.grpc.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<top.niandui.grpc.HelloReply> sayHello(
        top.niandui.grpc.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((top.niandui.grpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<top.niandui.grpc.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return top.niandui.grpc.HelloProto.getDescriptor();
    }
