 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://service.soap.niandui.top/", wsdlLocation = "http://localhost:8282/side_service/webservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("http://service.soap.niandui.top/", "WebServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8282/side_service/webservice?wsdl");
    ...
    public WebServiceImpl getWebServiceImplPort() {
        return super.getPort(new QName("http://service.soap.niandui.top/", "WebServiceImplPort"), WebServiceImpl.class);
    }
    ...
    public WebServiceImpl getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.soap.niandui.top/", "WebServiceImplPort"), WebServiceImpl.class, features);
    }
