...
-- ----------------------------
SELECT setval('"public"."seq_book"', 69, true);

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"public"."seq_config"', 22, true);

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
SELECT setval('"public"."seq_site"', 34, true);
...
INSERT INTO "public"."book" VALUES (69, '重生之网络争霸', 'http://www.biquge.info/75_75928/', 13, '2020-08-02 11:43:23', 'http://www.biquge.info/75_75928/15136955.html', '{"titleType":0,"startIndex":0,"delimiter":"","endType":0,"endCharacter":""}', 14, 0, 1);
