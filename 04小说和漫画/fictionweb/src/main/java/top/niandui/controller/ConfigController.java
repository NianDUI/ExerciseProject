...
public class ConfigController extends BaseController {
    ...
    @ApiOperation(value = "保存配置", notes = "时间：2020/04/06<br>无id为新增,有id为修改")
    ...
    @ApiOperation(value = "配置重名校验", notes = "时间：2020/04/06")
    ...
    @ApiOperation(value = "查询单个配置", notes = "时间：2020/04/06")
    ...
    @ApiOperation(value = "查询配置列表", notes = "时间：2020/04/06")
    ...
    @ApiOperation(value = "配置下拉", notes = "时间：2020/04/06")
    ...
    @ApiOperation(value = "删除配置", notes = "时间：2020/04/06")
