...
export default {
  ...
  data () {
    return {
      ...
      optionConfig: [],
      optionProxy: [],
      form: { bookid: null, name: '', siteid: null, configid: null, url: '', starturl: '', taskswitch: 1, detail: '' },
      handler: { getUtil: 'htmlunit', titleType: 0, startIndex: 0, delimiter: '', endType: 0, endCharacter: '', proxyid: 0 },
      originForm: null,
      originHandler: null
    }
  },
